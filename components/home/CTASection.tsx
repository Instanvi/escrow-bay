...
export default function CTASection() {
  return (
    <section className="py-24 bg-[#080C0E] relative border-t border-white/10 overflow-hidden">
      {/* Background glow halos */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-[#00F59B]/10 rounded-full blur-[140px] pointer-events-none" />

      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-[#0B1013] rounded-3xl p-8 sm:p-14 border border-emerald-500/30 text-center space-y-6 relative overflow-hidden shadow-2xl">
